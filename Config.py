...
class Config:
    ...
    BOT_TOKEN = os.environ.get("2070967057:AAEPcg8QqERhLPFO0wFUwoN5iN1TGofA6pY", None)  # Change None to your BOT_TOKEN
    OWNER_ID = int(os.environ.get("1662123902", 0))  # Change 0 to your OWNER_ID
    OWNER_NAME = os.environ.get("szdeveloper", None)  # Change None to your OWNER_NAME
    ...
    # If got any problem ask in @szbots.
